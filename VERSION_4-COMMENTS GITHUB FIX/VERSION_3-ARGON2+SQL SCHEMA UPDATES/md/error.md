Despite Correct Details:

admin@phishnet.com
PhishNetAdmin124

AAttempting admin login for: admin@phishnet.com
Argon2 verification error: Invalid hashed value
com.password4j.BadParametersException: Invalid hashed value
	at com.password4j.Argon2Function.decodeHash(Argon2Function.java:403)
	at com.password4j.Argon2Function.check(Argon2Function.java:248)
	at com.password4j.HashChecker.with(HashChecker.java:151)
	at util.SecurityUtils.verifyPassword(SecurityUtils.java:110)
	at service.AdminAuthenticationService.authenticate(AdminAuthenticationService.java:44)
	at controller.AdminLoginController.handleLogin(AdminLoginController.java:46)
...
Admin authentication: Invalid password for email: admin@phishnet.com
Login failed - admin is null
