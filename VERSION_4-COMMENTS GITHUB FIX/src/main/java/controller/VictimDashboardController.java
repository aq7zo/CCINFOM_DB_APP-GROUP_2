...
public class VictimDashboardController {
    ...
    private void handleLogout() {
        try {
            ...
            // Get current stage and replace scene with login
            ...
            showAlert("Logged out successfully."); // Inform the user
        } catch (IOException e) {
            e.printStackTrace();
            showError("Logout failed: " + e.getMessage()); // Show error if logout fails
        }
    }
