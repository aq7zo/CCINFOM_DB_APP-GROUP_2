...
/**
 * Minimal, focused test to confirm that the password4j library works correctly
 * in all common usage scenarios, especially mixing default .withArgon2()
 * with explicit Argon2Function instances.
 *
 * This was written during a debugging session when we weren't sure whether
 * verification was failing because of:
 * - the library itself
 * - mismatched Argon2 parameters
 * - or something in our own wrapper code
 */
public class SimplePassword4jTest {
    ...
    public static void main(String[] args) {
        ...
        // Test 1: Use the simple default .withArgon2() for both hashing and verification
        ...
        // Test 2: Explicit Argon2Function for both hashing and verification
        ...
        // Test 3: Generate with explicit function, verify with default .withArgon2()
        // (this is the recommended way — password4j reads parameters from the hash string)
        ...
        // Test 4: Generate with default .withArgon2(), verify with explicit function
